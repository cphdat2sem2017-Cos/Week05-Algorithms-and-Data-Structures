...
public class BinaryTree {
    ...
    /** 
     * Iterates through the tree using a left-to-right in-order traversal 
     * to collect all elements in their sorted order.
    ...
    private void getSorted(Node root, List<Integer> res) {
        if (root == null) {
            return;
        }
        // left
        getSorted(root.left, res);
        // parent
        res.add(root.data);
        // right
        getSorted(root.right, res);
    }
